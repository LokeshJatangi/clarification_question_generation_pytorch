...
def read_data(context_fname, question_fname, answer_fname, ids_fname,
    ...
    if ids_fname is not None:
        ids = []
        for line in open('/content/gdrive/MyDrive/Clarification Question generation- GANs-Dataset/askubuntu_unix_superuser/test_ids', 'r').readlines():
            curr_id = line.strip('\n')
            ids.append(curr_id)
    ...
    data = []
    i = 0
    for line in open('/content/gdrive/MyDrive/Clarification Question generation- GANs-Dataset/askubuntu_unix_superuser/test_context.txt', 'r').readlines():
    ...
    i = 0
    for line in open('/content/gdrive/MyDrive/Clarification Question generation- GANs-Dataset/askubuntu_unix_superuser/test_question.txt', 'r').readlines():
