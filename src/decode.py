...
def main(args):
    print('Enter main')
    word_embeddings = p.load(open('/content/gdrive/MyDrive/Clarification Question generation- GANs-Dataset/Dataset/embeddings/askubuntu_unix_superuser/word_embeddings.p', 'rb'))
    print('Loaded emb of size %d' % len(word_embeddings))
    word_embeddings = np.array(word_embeddings)
    word2index = p.load(open('/content/gdrive/MyDrive/Clarification Question generation- GANs-Dataset/Dataset/embeddings/askubuntu_unix_superuser/vocab.p', 'rb'))
