...
CQ_DATA_DIR=/content/clarification_question_generation_pytorch/$SITENAME
SCRIPT_DIR=/content/clarification_question_generation_pytorch/src
EMB_DIR=/content/clarification_question_generation_pytorch/embeddings/$SITENAME
